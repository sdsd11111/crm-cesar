...
function hydrateFiles(token, options) {
    ...
    const buildFilePath = (_d = options === null || options === void 0 ? void 0 : options.buildFilePath) !== null && _d !== void 0 ? _d : undefined;
    const buildPath = (path) => buildFilePath !== undefined
        ? buildFilePath(root, token, path, environment)
        : path;
    const methods = (0, files_js_1.getFileMethods)(buildLink, buildPath);
...
const defaultBuildFileUrl = (root, token, path, env) => {
