...
## 3. Vía HTTP: Generar PDF y Enviar por WhatsApp
Si César te pide **"envíale esta cotización por WhatsApp"**, no necesitas entrar a la base de datos ni generar PDFs tú misma.
Puedes utilizar este endpoint diseñado específicamente para ti:

### `POST /api/bot/send-document`
Este endpoint genera el PDF en el CRM y lo envía por WhatsApp.
- **Headers requeridos:** `Authorization: Bearer <DONNA_API_SECRET>`
- **Payload esperado (JSON):**
```json
{
  "phone": "593966410409", // OBLIGATORIO: Número con código de país, sin '+'
  "content": "# Markdown completo del documento...", // OBLIGATORIO: Tu documento redactado
  "documentType": "quotation", // OPCIONAL: quotation, contract, generic
  "messageText": "Hola, te adjunto la propuesta solicitada.", // OPCIONAL: Mensaje de WhatsApp
  "title": "Cotizacion Hotel XYZ", // OPCIONAL: Para nombrar el archivo PDF
  
  // Si incluyes estos datos opcionales, el CRM guardará el registro en la BD:
